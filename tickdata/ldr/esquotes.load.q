/ 2018.12.09T14:24:27.659 peppy weaves
/ q esquotes_09.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q esquotes_09.load.q FILE
/ q esquotes_09.load.q
/ q esquotes_09.load.q -help
FILE:LOADFILE:`$":../cache/in/esquotes_09.csv1"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q esquotes_09.load.q [FILE(default:../cache/in/esquotes_09.csv1)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`esquotes
LOADFMTS:"S TEHEHC "
LOADHDRS:`sym0`tm0`bpx0`bsz0`apx0`asz0`mkt0
