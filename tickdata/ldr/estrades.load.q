/ 2018.12.09T13:20:04.547 peppy weaves
/ q estrades_09.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q estrades_09.load.q FILE
/ q estrades_09.load.q
/ q estrades_09.load.q -help
FILE:LOADFILE:`$":../cache/in/estrades_09.csv1"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q estrades_09.load.q [FILE(default:../cache/in/estrades_09.csv1)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
