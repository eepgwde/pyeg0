...
print("")
print("Custom Inform")
MI.Option_Static("Inform", "General;Example : Duration=%Duration/String3%")
print(MI.Inform())

print("")
print("Custom Inform")
MI.Option_Static("Inform", "Audio;%Duration/String3%")
print(MI.Inform())
...
print(MI.Get(Stream.General, 0, "FileSize", Info.Text, Info.Name))
