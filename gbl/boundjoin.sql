...
, date_add(c.date_created, interval 7 day) as 'udt'
, date_sub(c.date_created, interval 7 day) as 'ldt'
...
, t.amount0
, v0.v1
from trans t inner join cmpl2 c2 on c2.party_id = t.party_id
  right join vwCmpl20 v0 on c2.source_complaint_id = v0.id
  and t.start_dt <= v0.udt and t.start_dt >= v0.ldt
  and t.amount0 <= v0.v1u and t.amount0 >= v0.v1l
order by c2.source_complaint_id;
