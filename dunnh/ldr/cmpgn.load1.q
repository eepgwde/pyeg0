/ 2021.08.12T11:49:11.510 emma weaves
/ q cmpgn.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cmpgn.load.q FILE
/ q cmpgn.load.q
/ q cmpgn.load.q -help
FILE:LOADFILE:`$":../cache/in/cmpgn.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cmpgn.load.q [FILE(default:../cache/in/cmpgn.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
