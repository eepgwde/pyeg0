/ 2021.08.12T11:49:12.572 emma weaves
/ q trns.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q trns.load.q FILE
/ q trns.load.q
/ q trns.load.q -help
FILE:LOADFILE:`$":../cache/in/trns.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q trns.load.q [FILE(default:../cache/in/trns.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`trns
SAVENAME:`trns
LOADFMTS:"HJHIHEHEUHEE"
LOADHDRS:`hhk`bskt`dd0`prdk`n`value`store`rtldisc`tm0`wk`cpndisc`cpnmdisc
