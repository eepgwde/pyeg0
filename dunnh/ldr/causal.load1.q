/ 2021.08.12T11:49:11.685 emma weaves
/ q causal.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q causal.load.q FILE
/ q causal.load.q
/ q causal.load.q -help
FILE:LOADFILE:`$":../cache/in/causal.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q causal.load.q [FILE(default:../cache/in/causal.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`causal
LOADFMTS:"HIHCC"
LOADHDRS:`prdk`store`wk`dsply`mlr
