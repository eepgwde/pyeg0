/ 2021.08.12T11:49:12.394 emma weaves
/ q prod.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q prod.load.q FILE
/ q prod.load.q
/ q prod.load.q -help
FILE:LOADFILE:`$":../cache/in/prod.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q prod.load.q [FILE(default:../cache/in/prod.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`prod
LOADFMTS:"IHSSSSS"
LOADHDRS:`prdk`mnfctr`dept`brnd`cmmdsc`cmm2dsc`psz
...
JUSTSYMFMTS:"  SSSSS"
JUSTSYMHDRS:`dept`brnd`cmmdsc`cmm2dsc`psz
