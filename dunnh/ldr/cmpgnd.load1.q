/ 2021.08.12T11:49:11.266 emma weaves
/ q cmpgnd.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cmpgnd.load.q FILE
/ q cmpgnd.load.q
/ q cmpgnd.load.q -help
FILE:LOADFILE:`$":../cache/in/cmpgnd.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cmpgnd.load.q [FILE(default:../cache/in/cmpgnd.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`cmpgnd
LOADFMTS:"SHHH"
LOADHDRS:`cmpgndsc`cmpgn`dd2`dd1
