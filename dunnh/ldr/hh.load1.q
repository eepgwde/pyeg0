/ 2021.08.12T11:49:12.208 emma weaves
/ q hh.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q hh.load.q FILE
/ q hh.load.q
/ q hh.load.q -help
FILE:LOADFILE:`$":../cache/in/hh.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q hh.load.q [FILE(default:../cache/in/hh.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`hh
LOADFMTS:"SCSSSSSH"
LOADHDRS:`aged`marital`idsc`hodsc`hhdsc`hhszd`kiddsc`hhk
...
JUSTSYMFMTS:"S SSSSS "
JUSTSYMHDRS:`aged`idsc`hodsc`hhdsc`hhszd`kiddsc
