/ 2018.03.20T12:35:42.173 j1 weaves
/ q ipv6.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q ipv6.load.q FILE
/ q ipv6.load.q
/ q ipv6.load.q -help
FILE:LOADFILE:`$":../cache/bak/IPv6.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q ipv6.load.q [FILE(default:../cache/bak/IPv6.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
