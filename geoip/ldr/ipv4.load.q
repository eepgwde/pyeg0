/ 2018.03.20T12:35:41.922 j1 weaves
/ q ipv4.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q ipv4.load.q FILE
/ q ipv4.load.q
/ q ipv4.load.q -help
FILE:LOADFILE:`$":../cache/bak/IPv4.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q ipv4.load.q [FILE(default:../cache/bak/IPv4.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`ipv4
LOADFMTS:"SIICBBSEFH"
LOADHDRS:`network`geonameid`registeredcountrygeonameid`representedcountrygeonameid`isanonymousproxy`issatelliteprovider`postalcode`latitude`longitude`accuracyradius
...
JUSTSYMFMTS:"S     S   "
JUSTSYMHDRS:`network`postalcode
