/ 2016.07.11T14:48:53.033 m1 weaves
/ q hexp065.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
...
SAVENAME:`hexp065
LOADFMTS:"SCHHFH"
LOADHDRS:`Categories`type0`decile`time`X`id
