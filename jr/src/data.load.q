/ 2016.05.08T20:02:37.777 m1 weaves
/ q data.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q data.load.q FILE
/ q data.load.q
/ q data.load.q -help
FILE:LOADFILE:`$":../bak/data.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q data.load.q [FILE(default:../bak/data.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`data
SAVENAME:`data
LOADFMTS:"HSSFFFFFFFFFFFFFFFFFFFFFFFFFF"
LOADHDRS:`dt0`sample0`folio0`x1`x2`x3`x4`x5`x6`x7`x8`x9`x10`x11`x12`x13`x14`x15`x16`x17`x18`x19`x20`x21`x22`x23`x24`r0`fcst
...
JUSTSYMFMTS:" SS                          "
JUSTSYMHDRS:`Sample`PortfolioCode
