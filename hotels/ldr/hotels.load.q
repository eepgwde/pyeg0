/ 2018.05.07T10:55:41.424 n1 weaves
/ q hotels.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q hotels.load.q FILE
/ q hotels.load.q
/ q hotels.load.q -help
FILE:LOADFILE:`$":../cache/in/hotels.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q hotels.load.q [FILE(default:../cache/in/hotels.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`hotels
SAVENAME:`hotels
LOADFMTS:"SSSSHSEEEFHFEEEFFFFFFEE"
LOADHDRS:`hotelid`city`country`airport`category`currency`starrating`conf`chainid`rate1`capacity`logprc`density`reviewrating`reviewcnt`loghistprc`rate2`rate3`density2`density3`radius500h`ycoord`xcoord
...
JUSTSYMFMTS:"SSSS S                 "
JUSTSYMHDRS:`hotelid`city`country`airport`currency
