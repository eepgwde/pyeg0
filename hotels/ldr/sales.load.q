/ 2018.05.07T10:56:11.977 n1 weaves
/ q sales.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q sales.load.q FILE
/ q sales.load.q
/ q sales.load.q -help
FILE:LOADFILE:`$":../cache/in/sales.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q sales.load.q [FILE(default:../cache/in/sales.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`sales
LOADFMTS:"DSF"
LOADHDRS:`transdate`hotel`sales
