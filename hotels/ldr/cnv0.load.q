/ 2018.03.24T10:15:46.577 j1 weaves
/ q cnv0.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cnv0.load.q FILE
/ q cnv0.load.q
/ q cnv0.load.q -help
FILE:LOADFILE:`$":../cache/in/cnv0.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cnv0.load.q [FILE(default:../cache/in/cnv0.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`cnv0
SAVENAME:`cnv0
LOADFMTS:"IIISCIIIFII"
LOADHDRS:`adid`xyzcampaignid`fbcampaignid`age`gender`interest`impressions`clicks`spent`totalconversion`approvedconversion
