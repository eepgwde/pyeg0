/ 2019.10.19T03:24:05.353 j1 weaves
/ q notifications.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q notifications.load.q FILE
/ q notifications.load.q
/ q notifications.load.q -help
FILE:LOADFILE:`$":cache/in/notifications.csv0"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q notifications.load.q [FILE(default:cache/in/notifications.csv0)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
JUSTSYMFMTS:"SSS  "
JUSTSYMHDRS:`reason`channel`status
